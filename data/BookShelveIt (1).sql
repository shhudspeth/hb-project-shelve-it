...
ALTER TABLE "userBookSources" ADD FOREIGN KEY ("user_libraries_id") REFERENCES "library" ("library_id");

ALTER TABLE "userBookSources" ADD FOREIGN KEY ("user_bookstores_id") REFERENCES "indieBookstore" ("bookstore_id");
